...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2021 at 06:01 AM
...
CREATE TABLE `tbl_pins` (
  ...
  `dur_start` int(10) NOT NULL,
  `dur_stop` int(10) NOT NULL,
  `hour_box` tinyint(1) NOT NULL,
  `min_box` tinyint(1) NOT NULL,
  `sec_box` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
